...
public class LockerModePPattern extends AbsLockerMode implements LockPicturePatternView.OnPatternListener {

	private View mRootView;

	private ConfigManager config;
	
	private LockPicturePatternView mPatternView;
	private TextView mTVDrawPattern;
	
	private boolean isLaunchCamera;
	private Notification notification;
	public LockerModePPattern(Context context) {
		super(context);
	...
	protected void initViews() {
		mRootView = getInflater().inflate(R.layout.layout_locker_mode_ppattern, null, false);
		mPatternView = (LockPicturePatternView) mRootView.findViewById(R.id.lppv_lockview);
