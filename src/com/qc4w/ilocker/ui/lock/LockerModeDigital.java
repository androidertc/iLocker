...
public class LockerModeDigital extends AbsLockerMode implements OnClickListener {
	...
	public LockerModeDigital(Context context) {
		super(context);
	...
	protected void initViews() {
		mRootView = getInflater().inflate(R.layout.layout_locker_mode_digital, null, false);
		
		indicator = (EnterDigitalIndicator) mRootView.findViewById(R.id.edi_indicator);
		mRootView.findViewById(R.id.dpv_password_view).setOnClickListener(this);
	}
