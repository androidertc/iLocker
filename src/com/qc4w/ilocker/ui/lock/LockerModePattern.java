...
public class LockerModePattern extends AbsLockerMode implements LockPatternView.OnPatternListener {
	...
	public LockerModePattern(Context context) {
		super(context);
	...
	protected void initViews() {
		mRootView = getInflater().inflate(R.layout.layout_locker_mode_pattern, null, false);
		mPatternView = (LockPatternView) mRootView.findViewById(R.id.lpv_lockview);
