...
public class CPatternCreatePasswordFragment extends FragmentBase implements OnClickListener, LockCPicturePatternView.OnPatternListener {
	...
	private LockCPicturePatternView mPasswordView;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_cpattern_create_password, container, false);
		initUI();
		return mRootLayout;
	}
