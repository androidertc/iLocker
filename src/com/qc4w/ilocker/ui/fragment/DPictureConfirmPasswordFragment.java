...
public class DPictureConfirmPasswordFragment extends FragmentBase implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_dpicture_confirm_password, container, false);
		initUI();
		return mRootLayout;
	}
