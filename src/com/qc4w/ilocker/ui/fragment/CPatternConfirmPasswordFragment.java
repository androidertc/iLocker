...
public class CPatternConfirmPasswordFragment extends FragmentBase implements LockCPicturePatternView.OnPatternListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_cpattern_confirm_password, container, false);
		initUI();
		return mRootLayout;
	}
