...
public class DigitalCreatePasswordFragment extends FragmentBase implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_digital_create_password, container, false);
		initUI();
		return mRootLayout;
	}
