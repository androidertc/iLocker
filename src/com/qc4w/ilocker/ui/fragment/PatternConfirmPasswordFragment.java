...
public class PatternConfirmPasswordFragment extends FragmentBase  implements LockPatternView.OnPatternListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_pattern_confirm_password, container, false);
		initUI();
		return mRootLayout;
	}
