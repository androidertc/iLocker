...
public class PPictureCreatePasswordFragment extends FragmentBase implements OnClickListener, LockPicturePatternView.OnPatternListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_ppicture_create_password, container, false);
		initUI();
		return mRootLayout;
	}
