...
public class LPictureConfirmPasswordFragment extends FragmentBase  implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootLayout = inflater.inflate(R.layout.fragment_lpicture_confirm_password, container, false);
		initUI();
		return mRootLayout;
	}
