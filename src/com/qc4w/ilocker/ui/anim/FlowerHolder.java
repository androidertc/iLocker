...
package com.qc4w.ilocker.ui.anim;
...
public class FlowerHolder {
    ...
    public static final float OVAL_SIZE = 50f;
    public static final float OVAL_MAX_SIZE = 100f;
    ...
    public FlowerHolder(ShapeDrawable s) {
        shape = s;
    }
}
